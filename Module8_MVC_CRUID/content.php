               ...
               else
               {
                ...
                <div class="col-md-8 col-xs-12">
                    <div class="jumbotron">
                            ...
                            <h2>Edit Your Profile <span class="fa fa-user" style="font-size:50px; color:red"></span></h2>


                            <p align="justify" style="font-size:20px">
                              
                              <a href="<?php echo $mainurl;?>MyProfile"><button type="button" class="btn btn-lg btn-success"> Click to Update  Profile Here <span class="fa fa-edit" style="font-size:35px; color:red"></span></button></a>
                            </p>
